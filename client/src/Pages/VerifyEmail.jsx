        ...
        {loading ? (
          ...
          <div className="flex flex-col lg:p-8 max-w-[500px] p-4">
            ...
            <div className="flex gap-4 items-center justify-between mt-6">
              <Link to="/signup" className="flex items-center gap-x-2 text-richblack-5">
                <FaArrowLeft /><p className=" ">Back to Signup</p>
              </Link>
              <button className="text-blue-200 cursor-pointer">Resend it</button>
            </div>
          </div>
        )}
      </div>
